...
#   set_location_assignment PIN_B12 -to CLK_50 ;# Global Clock 9
   ...
   set_location_assignment PIN_H2 -to step ;# KEY0/BUTTON0 (right button covered)
   set_location_assignment PIN_G3 -to br_inc ;# KEY1/BUTTON1 (mid button - half covered)
   set_location_assignment PIN_F1 -to br_dec ;# KEY2/BUTTON2 (left button)
   ...
   set_location_assignment PIN_J6 -to toggle_timer ;# SW[0]
   set_location_assignment PIN_H5 -to toggle_stopper ;# SW[1]
   #set_location_assignment PIN_H6 -to  SW[2];# SW[2]
   set_location_assignment PIN_G4 -to sw_lr ;# SW[3]
   set_location_assignment PIN_G5 -to timer_load ;# SW[4]
   set_location_assignment PIN_J7 -to watch_load ;# SW[5]
   set_location_assignment PIN_H7 -to sel_state[0] ;# SW[6]
   set_location_assignment PIN_E3 -to sel_state[1] ;# SW[7]
   set_location_assignment PIN_E4 -to t_sel ;# SW[8]
   set_location_assignment PIN_D2 -to resetN ;# SW[9]
